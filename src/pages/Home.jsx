        ...
        <>
            <section className="px-8 py-16 text-center">
                ...
                <p className="mb-4 opacity-90">
                    We build immersive worlds and bold gameplay for players
                    everywhere.
                </p>
                <a
                    className="bg-f-accent text-black px-4 py-2.5 rounded-lg no-underline font-bold"
                    href="/contact"
                >
                    Work with us
                </a>
            ...
            <section id="games" className="flex gap-4 px-8 py-6">
                ...
                <Card title="Indie Originals">
                    <p>
                        Small teams, big ideas — experimental, polished
                        experiences.
                    </p>
                </Card>
            </section>
